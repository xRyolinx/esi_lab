...
class ProjetsStatsPage extends AuthTemplate
{
    ...
    public function __construct($title = 'Statistiques projets', array $data = [])
    {
        ...
        // lib to pdf
        $this->addJS("https://cdnjs.cloudflare.com/ajax/libs/html2pdf.js/0.10.1/html2pdf.bundle.min.js");
    }
    protected function content()
    {
        ...
        <div class="max-w-4xl mx-auto">
            <div class="flex justify-between items-center mb-8">
                ...
                <button onclick="exportStatsPDF()" type="button"
                    class="bg-primary text-white px-4 py-2 rounded hover:bg-primary-dark">Exporter en PDF</button>
            </div>
